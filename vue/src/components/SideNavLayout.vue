<template>
  <div class="flex min-h-screen">
    ...
    <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      ...
      <div class="flex flex-row items-center justify-center mt-10">
        <div class="flex items-left">
          <div class="mt-8 text-center">
            <img src="https://upload.wikimedia.org/wikipedia/en/d/d2/La_Union_State_University.png" alt="" class="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28">
      ...
      <div class="relative px-4 py-3 mx-2 my-2 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-slate-600 to-cyan-400">
