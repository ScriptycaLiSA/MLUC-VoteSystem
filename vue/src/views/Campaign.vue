  ...
  <div id="axiosForm">
    ...
    <div class="w-full ">
      ...
      ">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-1 gap-6 py-2">
            <div class="w-full bg-gray-300 rounded-xl shadow-lg overflow-hidden flex flex-col md:flex-row">
              <div class="w-full md:w-2/5 h-80">
                <img class="object-center object-cover w-full h-full rounded-3xl" :src="getImgInfo(candData[key].image)"
                     alt="photo">
              </div>
        ...
        <div class="items-center text-gray-900 font-extrabold text-3xl" v-if="error">No Voting Event as per today.
